...
//            var_dump($data['states']);
    ...
    public function put_image($type, $destination)
    {
        ...
        if (!@$_FILES['fileToUpload']['error']) {
            ...
            ($_SERVER['SERVER_NAME'] == 'localhost' ? $target_dir = "/Applications/XAMPP/xamppfiles/htdocs/bba/assets/uploads/" :
                ($_SERVER['SERVER_NAME'] == 'webdev.highlands.edu' ? $target_dir = "/var/www/html/bba/assets/uploads/" :
                    $target_dir = "/var/www/forms/bba/assets/uploads/" ));
